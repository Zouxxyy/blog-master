$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: 'id', name: 'commentId', index: 'commentId', width: 40, key: true, hidden: true},
            {label: '评论人', name: 'commentAuthorName', index: 'commentAuthorName', width: 40},
            {label: '评论内容', name: 'commentContent', index: 'commentContent', width: 180},
            {label: '评论文章', name: 'commentArticleTitle', index: 'commentArticleTitle', width: 150},
            {label: '评论时间', name: 'commentCreateTime', index: 'commentCreateTime', width: 80},
